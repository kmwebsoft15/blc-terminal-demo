...
import { Wrapper, Label } from '../Modals/Components';
            ...
            <Wrapper>
                <Label>
                    <span>
                        {!isShow ?
                            <FormattedMessage
                                id="modal.seed_words.label_warning"
                                defaultMessage="WARNING"
                            /> :
                            isBackUp ?
                                <FormattedMessage
                                    id="modal.seed_words.label_enter_word"
                                    defaultMessage="Enter Your 12-Word Phrase"
                                /> :
                                <FormattedMessage
                                    id="modal.seed_words.label_view_word"
                                    defaultMessage="View Your 12-Word Phrase"
                                />
                        }
                    </span>
                </Label>
                    ...
                    {!isShow
                        ? (
                            <React.Fragment>
                                ...
                                <Heading>
                                    <FormattedMessage
                                        id="modal.seed_words.label_heading"
                                        defaultMessage="Show 12-Word Phrase?"
                                    />
                                </Heading>
                                    ...
                                    {isInProgress
                                        ...
                                        : (
                                            <span className="btn-text">
                                                <FormattedMessage
                                                    id="modal.seed_words.label_show_phrase"
                                ...
                                <InputRowWrapper>
                                    {SEED_WORDS.map((word, idx) => (
                                        <WordInputWrapper key={idx}>
                                            ...
                                            <InputValueWrapper><WordInput/></InputValueWrapper>
                                        </WordInputWrapper>
                                    ))}
                                </InputRowWrapper>
...
export default inject(STORE_KEYS.MODALSTORE, STORE_KEYS.EXCHANGESSTORE)(
    observer(SeedWordsModal),
);
