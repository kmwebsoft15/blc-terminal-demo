...
export const ExchDropdownList = styled.div`
    height: ${props => props.itemCount === 0 ? 100 : props.isSearching ? 880 : props => props.itemCount > 4 ? 440 : props.itemCount * 110}px;

    .exch-dropdown__list__rvtable-wrapper {
        height: ${props => props.itemCount === 0 ? 100 : props.isSearching ? 880 : props.itemCount > 4 ? 440 : props.itemCount * 110}px;
    }
...
export const CoinAmountInput = styled.input`
    font-size: 40px;
    font-weight: 600;
    color: ${props => props.theme.palette.coinPairSelectHoverText2};
