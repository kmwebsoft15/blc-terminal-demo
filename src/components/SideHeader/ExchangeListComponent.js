...
import ExchangeList from '../WalletHeader/ExchangeSelector/ExchangeList';
...
class ExchangeListComponent extends Component {
    ...
    handleClickOutside = (event) => {
        ...
        if (isFromOrderBook && this.wrapperRef && this.wrapperRef.contains && !this.wrapperRef.contains(event.target) && !this.props.isApiKeyModalOpened) {
