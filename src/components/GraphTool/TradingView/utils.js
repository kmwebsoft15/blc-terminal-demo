...
export const drawHistoryGraph = (bars, firstDataRequest, onDataCallback, symbolInfo, resolution, onErrorCallback, apiDataLoadObservable) => {
    let normalizedBars;
    ...
    fetch(url)
        ...
        .then(Data => {
            ...
            if (firstDataRequest) {
                // TODO handle correct
                try {
                    this.lastBarTime = roundTimeByInterval(normalizedBars[normalizedBars.length - 1].time, INTERVAL_MAP[resolution]);
                } catch (e) {
                    // console.log(e);
                }
            }
...
export const drawHistoryGraphWithMultiply = (bars, firstDataRequest, onDataCallback, symbolInfo, resolution, onErrorCallback, apiDataLoadObservable) => {
