...
export default {
    ...
    getBars: function(
        ...
        historyProvider
            ...
            .then(bars => {
                if (bars.length > 0) {
                    return drawHistoryGraph(bars, firstDataRequest, onHistoryCallback, symbolInfo, resolution, onErrorCallback, apiDataLoadObservable);
                }
                ...
                historyProvider.getBars(symbolInfo, resolution, from, to , firstDataRequest)
                    .then(bars => {
                        return  drawHistoryGraphWithMultiply(bars, firstDataRequest, onHistoryCallback, getSymbol(noDataSymbolInfo), resolution, onErrorCallback, apiDataLoadObservable);
                    })
