...
currencies.forEach(currency => {
    if (currencyList.length > 0 && currencyList[currencyList.length - 1].code === currency.code) {
        currencyList[currencyList.length - 1].countries.push({
        ...
        currencyList.push({
            ...
            digitalCode: currency.digitalCode,
            name: currency.name,
            countries: [{
                name: currency.country,
                posX: currency.posX,
