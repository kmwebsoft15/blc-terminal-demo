...
const BuyArrowIconSvg = styled.svg`
    width: ${props => props.width || '100%'};
    height: ${props => props.width || '100%'};
    fill: ${palette.coinPairBuyArrow};
    text {
        font-weight: bold;
        font-size: 16px;
        text-anchor: start;
...
export const BuyArrowIcon = props => (
    <BuyArrowIconSvg {...props} viewBox="0 0 102 82">
        <g>
            ...
            {props.withText && <text y="45.007112" x="52.328387">BUY</text>}
        </g>
    </BuyArrowIconSvg>
);

const SellArrowIconSvg = styled.svg`
    width: ${props => props.width || '100%'};
    height: ${props => props.width || '100%'};
    fill: ${palette.coinPairSellArrow};
    text {
        font-weight: bold;
        font-size: 16px;
        text-anchor: start;
...
export const SellArrowIcon = props => (
    <SellArrowIconSvg {...props} viewBox="0 0 102 82">
        <g>
            ...
            {props.withText && <text y="45.64057" x="10.692575">SELL</text>}
        </g>
    </SellArrowIconSvg>
);